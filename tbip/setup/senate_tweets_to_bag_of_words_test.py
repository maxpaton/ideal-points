...
tweets_df = pd.read_csv(os.path.join(data_dir, "covid_tweets.csv"), index_col=0)

tweets = np.array(tweets_df['tweet'])
...
counts = count_vectorizer.fit_transform(tweets.astype(str))
vocabulary = np.array(
